...
abstract class AbstractPdf extends \Magento\Sales\Model\Order\Pdf\AbstractPdf
{
    ...
    protected function insertAddress(&$page, $store = null)
    {
        ...
        $top = 815;
        $font = $this->_setFontRegular($page, 11);
    ...
    protected function insertQuote(&$page, $obj, $putQuoteId = true)
    {
        ...
        $page->drawRectangle(25, $top, 295, $top - 25);
        $page->drawRectangle(295, $top, 570, $top - 25);
        ...
        if (!$quote->getIsVirtual()) {
            $page->drawText(__('Ship to:'), 305, $top - 15, 'UTF-8');
        } else {
        ...
        if (!$quote->getIsVirtual()) {
            ...
            foreach ($shippingAddress as $value) {
                if ($value !== '') {
                    ...
                    foreach ($text as $part) {
                        $page->drawText(strip_tags(ltrim($part)), 305, $this->y, 'UTF-8');
                        $this->y -= 15;
                    }
                }
            }
